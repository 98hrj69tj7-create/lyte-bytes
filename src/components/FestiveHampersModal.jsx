          ...
          <form onSubmit={submitHamperWhatsApp} style={{ display: 'flex', flexDirection: 'column', gap: '10px', width: '100%', boxSizing: 'border-box' }}>
            ...
            <div style={{ display: 'flex', gap: '8px', width: '100%', boxSizing: 'border-box' }}>
              ...
              <input 
                ...
                style={{
                  flex: 1, minWidth: 0, padding: '12px 14px', borderRadius: '12px',
                  border: '1px solid rgba(197, 160, 89, 0.5)', backgroundColor: '#FFF',
                  fontSize: '14px', boxSizing: 'border-box', outline: 'none', color: '#1A1816', cursor: 'pointer'
                }}
              />
            </div>
            ...
            <textarea 
              ...
              style={{
                width: '100%', padding: '12px 14px', borderRadius: '12px',
                border: '1px solid rgba(197, 160, 89, 0.5)', backgroundColor: '#FFF',
                fontSize: '14px', boxSizing: 'border-box', outline: 'none', color: '#1A1816', resize: 'none', marginTop: '2px'
              }}
            />
            ...
            <button 
              ...
              style={{
                ...
                fontSize: '14.5px', fontWeight: '700', cursor: 'pointer', display: 'flex',
                alignItems: 'center', justifyContent: 'center', gap: '6px',
                boxShadow: '0 4px 12px rgba(37, 211, 102, 0.3)', marginTop: '6px', marginBottom: '10px', width: '100%', boxSizing: 'border-box'
              }}
            >
