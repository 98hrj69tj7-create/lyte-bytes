  ...
  const modalContent = (
    ...
    >
      ...
      >
        ...
        {/* Form Body Container */}
        <div style={{ padding: '8px 14px 16px 14px', position: 'relative', boxSizing: 'border-box' }}>
          <div 
            style={{
              background: 'linear-gradient(135deg, #FFFDF9 0%, #FAF4EB 100%)',
              borderRadius: '16px',
          ...
          >
            <div style={{ marginBottom: '10px', textAlign: 'left' }}>
              ...
              <p style={{ margin: 0, fontSize: '11px', color: '#78716C', fontWeight: '500', lineHeight: '1.4' }}>
                Share your event specs to submit or discuss instantly via WhatsApp.
              </p>
            </div>

            <form onSubmit={submitBulkWhatsApp} style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              {/* Name Field */}
              <input 
                type="text"
                ...
                style={{
                  ...
                  fontSize: '12px', boxSizing: 'border-box', outline: 'none', color: '#1A1816'
                }}
              />
              ...
              {/* Guests and Date Row with minWidth: 0 to prevent overflow */}
              <div style={{ display: 'flex', gap: '8px', width: '100%', boxSizing: 'border-box' }}>
                <input 
                  type="text"
                  placeholder="Approx. Guests / Qty"
                  required
                ...
                <input 
                  ...
                  style={{
                    flex: 1, minWidth: 0, padding: '10px 12px', borderRadius: '10px',
                    border: '1px solid rgba(197, 160, 89, 0.5)', backgroundColor: '#FFF',
                    fontSize: '12px', boxSizing: 'border-box', outline: 'none', color: '#1A1816', cursor: 'pointer'
                  }}
                />
              </div>
                    ...
                    return (
                      <button
                        ...
                        style={{
                          ...
                          boxShadow: isSelected ? '0 2px 5px rgba(197, 160, 89, 0.3)' : 'none'
                        }}
                      >
                        {isSelected ? '✓ ' : '+ '}{item}
                      </button>
              ...
              <textarea 
                ...
                style={{
                  width: '100%', padding: '10px 12px', borderRadius: '10px',
                  border: '1px solid rgba(197, 160, 89, 0.5)', backgroundColor: '#FFF',
                  fontSize: '12px', boxSizing: 'border-box', outline: 'none', color: '#1A1816', resize: 'none', marginTop: '2px'
                }}
              />
              ...
              <button 
                ...
                style={{
                  background: '#25D366',
                  color: '#FFF', border: 'none', borderRadius: '11px', padding: '11px',
              ...
              >
                <MessageSquare size={15} /> Send Inquiry via WhatsApp
              </button>
            </form>
          </div>
        </div>
