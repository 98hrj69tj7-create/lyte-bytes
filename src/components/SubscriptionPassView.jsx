...
import { ArrowLeft, Club, ArrowRight, Sparkles, LogIn } from 'lucide-react';
...
export default function SubscriptionPassView({ theme = {}, customer = {}, setCustomer = () => {}, setView = () => {}, setCart = () => {} }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', overflowY: 'auto', flex: 1, paddingBottom: '20px', paddingTop: '6px', boxSizing: 'border-box', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      
      <div style={{ display: 'flex', alignItems: 'center', position: 'relative', marginBottom: '20px', padding: '6px 0' }}>
        <button 
          onClick={() => setView('subcat')} 
          style={{ background: 'rgba(255, 255, 255, 0.6)', border: '1px solid rgba(197, 160, 89, 0.3)', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px', color: activeTheme.text, fontSize: 'var(--font-caption)', fontWeight: '600', padding: '6px 10px', borderRadius: '12px', zIndex: 1, transition: 'all 0.2s ease' }}
        >
          <ArrowLeft size={15}/> Back
        </button>
        <h2 style={{ position: 'absolute', left: 0, right: 0, textAlign: 'center', fontFamily: "'Cormorant Garamond', serif", fontSize: 'var(--font-h2)', color: '#FF5958', margin: 0, fontWeight: '700', letterSpacing: '0.5px', textTransform: 'uppercase', pointerEvents: 'none' }}>
          Subscription
        </h2>
      </div>

      <div style={{ border: '1px solid rgba(197, 160, 89, 0.4)', borderRadius: activeTheme.radius, background: 'linear-gradient(135deg, #FFFDF9 0%, #FAF4EB 100%)', padding: 'clamp(14px, 4vw, 18px)', boxShadow: '0 8px 24px rgba(44, 34, 30, 0.06)', display: 'flex', flexDirection: 'column', gap: '16px', boxSizing: 'border-box', width: '100%' }}>

        <div style={{ background: 'linear-gradient(135deg, #1A1816 0%, #2D2721 100%)', borderRadius: '20px', padding: '14px', textAlign: 'left', color: '#FFF', border: '3px solid rgba(197, 160, 89, 0.4)', boxShadow: '0 10px 30px rgba(0,0,0,0.15)', position: 'relative', overflow: 'hidden', boxSizing: 'border-box' }}>
          ...
          <p style={{ fontSize: 'var(--font-caption)', color: '#D4D4D8', margin: 0, lineHeight: '1.6', fontWeight: '400' }}>
            Wholesome, home-style meals for you or your family. <br />
        ...
        {/* Incentive Banner */}
        <div style={{ background: 'linear-gradient(135deg, rgba(197, 160, 89, 0.15) 0%, rgba(255, 89, 88, 0.08) 100%)', border: '1px solid rgba(197, 160, 89, 0.4)', borderRadius: '14px', padding: '12px 14px', display: 'flex', alignItems: 'center', gap: '10px', boxSizing: 'border-box' }}>
          <LogIn size={18} color="#C5A059" style={{ flexShrink: 0 }} />
          <div style={{ fontSize: 'var(--font-caption)', color: '#1A1816', lineHeight: '1.4', fontWeight: '500', textAlign: 'left' }}>
            Sign in now to claim your 10% Welcome Offer.
            </div>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', textAlign: 'left' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <span onClick={() => setIsPolicyModalOpen(true)} style={{ fontSize: 'clamp(9.5px, 2.5vw, 10.5px)', color: activeTheme.brand, fontWeight: '700', cursor: 'pointer', textDecoration: 'underline' }}>
            ...
            {[
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: '700', fontSize: 'var(--font-caption)', cursor: 'pointer', textAlign: 'center', boxSizing: 'border-box'
                }}
              >
                {m.label}
              </button>
            ...
            {[
              ...
              <button
                ...
                style={{
                  ...
                  color: '#1A1816', cursor: 'pointer', textAlign: 'left', boxSizing: 'border-box'
                }}
              >
            ...
            {[
              ...
              <div
                ...
                style={{
                  ...
                  display: 'flex', justifyContent: 'space-between', alignItems: 'center', cursor: 'pointer', boxSizing: 'border-box'
                }}
              >
                <span style={{ fontWeight: '700', fontSize: 'var(--font-body)', color: '#1A1816' }}>{d.label}</span>
                <span style={{ fontSize: '9.5px', fontWeight: '800', backgroundColor: d.id === 'weekly' ? 'rgba(197, 160, 89, 0.2)' : '#FF5958', color: d.id === 'weekly' ? '#8A6D2B' : '#FFF', padding: '3px 7px', borderRadius: '6px' }}>
                  {d.badge}
                </span>
              </div>
            ))}
        ...
        <div style={{ background: '#FFFFFF', borderRadius: '14px', padding: '14px', border: '1px solid rgba(197, 160, 89, 0.4)', boxSizing: 'border-box' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', width: '100%', marginTop: '4px' }}>
          <button
            ...
            style={{
              ...
              borderRadius: '14px', fontWeight: '600', fontSize: 'var(--font-body)',
              cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center',
              gap: '8px', boxSizing: 'border-box', boxShadow: '0 4px 14px rgba(255, 89, 88, 0.3)'
            }}
          >
          ...
          <button 
            type="button"
            onClick={() => setView('subcat')}
            style={{ backgroundColor: 'rgba(197, 160, 89, 0.1)', border: '1px solid rgba(197, 160, 89, 0.3)', color: activeTheme.text, padding: 'clamp(10px, 3vw, 12px)', fontSize: 'var(--font-body)', fontWeight: '600', borderRadius: '14px', width: '100%', boxSizing: 'border-box', cursor: 'pointer' }}
          >
            Back to Categories
          </button>
        </div>
